for this project we use a YOLOV1 Model and the weights were learned in google colab for 30 min only on 433  plate picture and 4952 background image  do the model can sometime 
